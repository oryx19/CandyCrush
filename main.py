...
class Config():
    CSV_PATH = BackEnd.resource_path('exemple_grille.csv')   # ← adaptez ce chemin
    ...
    boardwidth  = len(grille_init[0])  
    boardheight = len(grille_init)      
...
class UserInterface():
    def __init__(self):
        ...
        self.basic_font = pygame.font.Font(None, 36)   
